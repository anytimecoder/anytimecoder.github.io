...
},{"../src/Datepicker.js":161,"react":159}],2:[function(require,module,exports){
	...
	render: function render() {
		...
		data.forEach((function (item, i) {
			values.push(React.createElement(
				'td',
				{ key: item, onClick: this.props.onClick },
				item
			));
			year++;
...
var Datepicker = React.createClass({
	...
	buildSelectBox: function buildSelectBox() {
		...
		switch (this.state.stage) {
			case 1:
				return React.createElement(DataTable, { data: this.props.months, onClick: this.selectItem, columns: 4 });
			case 2:
				for (i = 0; i < this.daysInMonth(this.state.valueYear, this.state.valueMonth); i++) {
					data[i] = i + 1;
				}
				return React.createElement(DataTable, { data: data, onClick: this.selectItem, columns: 8 });
			default:
				for (i = 0; i < this.props.numberOfYears; i++) {
					data[i] = this.props.startYear + i;
				}
				return React.createElement(DataTable, { data: data, onClick: this.selectItem });
		}
	},
...
},{"./DataTable":160,"check-defined":3,"classnames":4,"react":159}]},{},[1])
